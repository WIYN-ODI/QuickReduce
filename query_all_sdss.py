...
#             "max_dec": -32,}
        ...
        primhdu.header.update("EXPCOUNT", count, "expected return count")
        primhdu.header.update("CNTSRECV", sdss_cat.shape[0], "returned count")
        primhdu.header.update("R_MIN", r_min[i], "min RA")
        primhdu.header.update("R_MAX", r_max[i], "max RA")
        primhdu.header.update("D_MIN", d_min[i], "min DEC")
        primhdu.header.update("D_MAX", d_max[i], "max DEC")
