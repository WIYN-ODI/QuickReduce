...
def find_center(hdu_data, lx, ly, prebin=8, r_minmax=[100,200], x_minmax=[400,600], y_minmax=[400,600], 
                dx=2, dy=2, dr=2):


    ot33b = rebin_image(hdu_data, prebin)
...
#    ly = [0, 400,-100,-100,400]
    ...
    for i in range(1,5):
        ...
        x, y, r, bincount, edge_frame = find_center(rawdata, lx[i], ly[i], 
