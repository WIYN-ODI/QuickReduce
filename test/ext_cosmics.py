...
This is the "optimzied" version by pratjamjoshi
see https://github.com/STScI-Citizen-Science/FastCosmics for details
and license
...
class cosmicsimage:
    ...
    def findsatstars(self, verbose = None):
        ...
        #R outmask = np.zeros(self.rawarray.shape) 
        #R outmask = np.logical_and(outmask,satstarscenters)
        #R outmask = np.where(outmask>0,np.logical_or(outmask,dilsatlabels))

        outmask = dilsatlabels
